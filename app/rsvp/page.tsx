...
export default function RsvpPage() {
  return (
    <PageFrame>
      <main className="mx-auto flex max-w-3xl flex-col gap-12 px-6 py-10 sm:px-10">
        <section className="text-center">
          <div className="relative h-56 overflow-hidden rounded-t-[50%] rounded-b-2xl shadow-lg shadow-primary/15">
        ...
        <RsvpForm />
        <section className="border-t border-outline-variant/50 pt-10 text-center">
